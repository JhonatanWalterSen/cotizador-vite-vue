<script setup>
  ...
  const pagoMensual = computed(()=> total.value / meses.value)
...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      ...
      <p class="text-center my-10 text-5xl font-extrabold text-green-600" v-text="formatearDinero(cantidad)"></p>
      ...
      class="w-full p-2 bg-white border border-gray-300 rounded-lg text-center text-2xl mt-5">
